...
(function () {
  ...
  style.textContent = [
    ...
    '.ft-btn:focus-visible{outline:2px solid #66c0f4;outline-offset:2px;border-radius:2px}',
    ...
    '.ft-close:focus-visible{outline:2px solid #66c0f4;outline-offset:2px}',
    ...
    '.ft-field input:focus,.ft-field textarea:focus,.ft-field select:focus{outline:none;border-color:#66c0f4}',
    '.ft-field textarea{resize:vertical;min-height:100px}',
    '.ft-field select option{background:#0f172a}',
    '.ft-submit{width:100%;padding:.65rem;background:#2563eb;color:#fff;border:none;border-radius:7px;font-size:.88rem;font-weight:700;cursor:pointer;font-family:inherit;transition:background .15s}',
    '.ft-submit:hover{background:#1d4ed8}',
    '.ft-submit:focus-visible{outline:2px solid #66c0f4;outline-offset:2px}',
  ...
  var html = [
    ...
    '      <h4>9. Contact</h4>',
    '      <p>For questions, concerns, or bug reports, use the Bug Report form or email <a href="mailto:joshuarelatorres28@gmail.com" style="color:#66c0f4">joshuarelatorres28@gmail.com</a>.</p>',
    '    </div>',
    '  </div>',
    '</div>',
